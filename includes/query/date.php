 ...
 * @since 3.7.0
 */
class USAM_Date_Query 
{
	public $queries = array();
	public $relation = 'AND'; // The default relation between top-level queries. Can be either 'AND' or 'OR'.
	public $column = 'date_insert'; //The column to query against. Can be changed via the query arguments.
	public $compare = '='; //The value comparison operator. Can be changed via the query arguments.
	public $table = '';
	 ...
	 * }	
	 */
	public function __construct( $date_query, $default_table = '', $default_column = 'date_insert' ) 
	{
