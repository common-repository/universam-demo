...
class USAM_List_Table_fb_users_profiles extends USAM_List_Table_Social_Network
{	
	protected $type_social = 'fb_user';
	
	function column_title( $item ) 
    {
		$actions = $this->standart_row_actions( $item->id, 'fb_user' );
