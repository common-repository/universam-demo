...
class USAM_Form_payment_received extends USAM_View_Form_Document
{		
	protected function get_title_tab()
	{ 	
		return sprintf( __('Поступление №%s от %s (%s)','usam'), $this->data['number'], usam_local_date( $this->data['date_insert'], "d.m.Y" ), $this->data['name'] );	
	}	
