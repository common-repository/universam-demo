...
class USAM_Form_meeting extends USAM_Form_Type_Event
{			
	protected $event_type = 'meeting';

	protected function data_default()
	{
		return ['type' => 'meeting', 'venue' => ''];
	}
	...
	{					
		...
		$this->add_action_lists( __('Список действий','usam') );	
    }	
