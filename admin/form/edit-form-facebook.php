...
class USAM_Form_facebook extends USAM_Form_Social_Network
{					
	protected function get_title_tab()
	{ 	
		if ( $this->id != null )
			$title = sprintf( __('Изменить бота Facebook &#171;%s&#187;','usam'), $this->data['name'] );
		else
			$title = __('Добавить бота Facebook', 'usam');	
		return $title;
	}	
