...
?>
<div id="fb_post_publication_wall" class="modal fade">
	...
	<div class='modal-body'>
		<div class='bulk_actions columns_2'>
			...
			<div class='columns_2__column'><div class='title'><?php _e('Выбранные посты','usam') ?></div><div class='selected_items modal-scroll'><div class='all_items_selected'><?php _e('Не выбран пост','usam') ?></div></div></div>
		</div>	
