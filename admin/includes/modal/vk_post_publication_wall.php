...
?>
<div id="vk_post_publication_wall" class="modal fade">
	<div class="modal-header">
		<span class="close" data-dismiss="modal" aria-hidden="true">×</span>
		<div class = "header-title"><?php _e('Публикация поста на стену','usam'); ?></div>
	</div>
		...
		<div class='bulk_actions columns_2'>
			<div class='columns_2__column'>
				<div class='edit_form'>
					...
					<div class='edit_form__item'>
						<textarea rows='10' autocomplete='off' cols='40' id='message_format' ><?php echo $options['post_message']; ?></textarea>
					</div>	
					<div class='edit_form__item'>
			...
			<div class='columns_2__column'><div class='title'><strong><?php _e('Выбранные посты','usam') ?></strong></div><div class='selected_items modal-scroll'><div class='all_items_selected'><?php _e('Не выбран пост','usam') ?></div></div></div>
		</div>	
