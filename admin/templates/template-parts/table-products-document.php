...
?>
<table-products :columns='<?php echo json_encode( $columns ); ?>' :table_name="data.type" :loaded="$root.loaded" :edit="edit" :items="data.products" @change="data.products=$event" :column_names='<?php echo json_encode( usam_get_columns_product_table() ); ?>' :taxes="data.product_taxes" :type_price="data.type_price">	
