...
class documents_Interface_Filters extends USAM_Interface_Filters
{	
	...
	{				
		$filters = [
			...
			'groups' => ['title' => __('Группы', 'usam'), 'type' => 'checklists', 'query' => ['type' => 'document']],
			...
			'document_types' => ['title' => __('Типы документов', 'usam'), 'type' => 'checklists'],
		];
		if ( isset($_GET['form']) )
