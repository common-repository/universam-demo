<?php
/*
Printing Forms:Акт приема-передачи неисключительных прав
type:crm
...
<?php
$columns = array( 'n' => "№", 'name' => __('Наименование лицензий','usam'), 'discount_price' => __('Цена','usam'), 'quantity' => __('Количество','usam'), 'unit_measure' => __('Eд.','usam'), 'total' => __('Всего','usam') );
if ( $this->edit )
	$print = '';
else
...
<head>		
	...
	<?php $this->style(); ?>	
	<title><?php echo esc_html__('Акт приема-передачи неисключительных прав', 'usam'); ?>: %id% <?php esc_html_e( 'от', 'usam'); ?> %date%</title>	
</head>
<body <?php echo $print; ?> style="margin: 0pt; padding: 15pt; width: 555pt; background: #ffffff">	
	<h1 style="text-align: center;">%%document_name input "<?php esc_html_e( 'Акт приема-передачи неисключительных прав', 'usam'); ?> №%id% <?php esc_html_e( 'от', 'usam'); ?> %date%" "Название документа"%%</h1>	
	
	<h2 style="text-align: left;">%%name_company input "Лицензиар" "Напишите название контрагента"%%</h2>				
	...
	<h2 style="text-align: left;">%%name_counterparty input "Лицензиат" "Напишите название контрагента"%%</h2>				
	...
	<p><?php _e( 'Всего наименований передано неисключительных прав %number_products%, на сумму %total_price_currency%', 'usam'); ?></p>
	<p class="total_price_word"><b>%total_price_word%</b></p>
	<p style="margin-top:10px;">%%description textarea "Вышеперечисленные перечисленные неисключительные права переданы Лицензиату в объеме заключенного между сторонами лицензионного договора." "Условия"%%</p>
	<div class ="invoice-footer" style="margin-top:20px">%%signatures textarea "<table style='table-layout:fixed'><tr><td><strong>Лицензиар</strong></td><td><strong>Лицензиат</strong></td></tr><tr><td>%recipient_company_name%</td><td>%customer_name%</td></tr><tr><td></td><td></td></tr><tr><td>______________________________________</td><td>______________________________________</td></tr><tr><td>%recipient_gm%</td><td>%customer_gm%</td></tr></table>" "Подписи"%%</div>
</body>
</html>		