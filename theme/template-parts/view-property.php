...
<div :class ="property.field_type+'_property'" v-else-if="property.field_type=='rating'">
	<div class="rating">
		<?php usam_svg_icon("star", ["class" => "star", "v-for" => "n in [1,2,3,4,5]", ":class" => '{"rating__selected":property.value<=n}']); ?>
	</div>
</div>
<div :class ="property.field_type+'_property'" v-else-if="property.mask!=''">{{property.value | VMask(property.mask)}}</div>
<div :class ="property.field_type+'_property'" v-else v-html="property.value"></div>